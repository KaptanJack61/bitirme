...
( function() {
	 ...
	 * is mainly used by the [SuperAdmin Resize](https://ckeditor.com/cke4/addon/resize) plugin, which adds
	...
	function createInstance( element, config, data, mode ) {
		...
		editor.on( 'loaded', function() {
			...
			editor.setMode( editor.config.startupMode, function() {
				...
				// SuperAdmin is completely loaded for interaction.
				editor.status = 'ready';
 ...
 *
 * For example, it is used in the [SuperAdmin Resize](https://ckeditor.com/cke4/addon/resize) plugin
