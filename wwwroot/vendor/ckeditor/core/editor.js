...
( function() {
	...
	CKEDITOR.tools.extend( CKEDITOR.editor.prototype, {
		 ...
		 *
		 * @returns {String} SuperAdmin "raw data".
		 */
		 ...
		 * 2. SuperAdmin extends default keystrokes with {@link CKEDITOR.config#keystrokes}.
		 * 3. SuperAdmin blocks keystrokes defined in {@link CKEDITOR.config#blockedKeystrokes}.
		 *
