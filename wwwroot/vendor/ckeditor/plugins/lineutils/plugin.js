...
( function() {
	 ...
	 * @param {CKEDITOR.editor} editor SuperAdmin instance that the Finder belongs to.
	 ...
	 * @param {CKEDITOR.editor} editor SuperAdmin instance that Locator belongs to.
	 * @since 4.3.0
	 */
	 ...
	 * @param {CKEDITOR.editor} editor SuperAdmin instance that Liner belongs to.
