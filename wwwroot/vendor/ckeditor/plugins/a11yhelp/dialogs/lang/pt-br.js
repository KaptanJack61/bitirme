...
CKEDITOR.plugins.setLang( 'a11yhelp', 'pt-br', {
	...
	legend: [
		...
		items: [
			{
			name: 'Barra de Ferramentas do SuperAdmin',
			...
			{
			name: 'Menu de Contexto do SuperAdmin',
			...
			{
			name: 'Caixa de Lista do SuperAdmin',
			...
			{
			name: 'Barra de Caminho do Elementos do SuperAdmin',
