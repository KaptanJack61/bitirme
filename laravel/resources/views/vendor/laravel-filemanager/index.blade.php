...
<head>
  ...
  @if ($title=="Files")
    <title>{{ trans('laravel-filemanager::lfm.title-page-files') }}</title>
  @elseif($title=="Images")
    <title>{{ trans('laravel-filemanager::lfm.title-page-media') }}</title>
  @endif
...
<body>
  <div class="container-fluid" id="wrapper">
    <div class="panel panel-primary hidden-xs">
      <div class="panel-heading">
        @if ($title=="Files")
          <h1 class="panel-title">{{ trans('laravel-filemanager::lfm.title-panel-files') }}</h1>
        @elseif($title=="Images")
          <h1 class="panel-title">{{ trans('laravel-filemanager::lfm.title-panel-media') }}</h1>
        @endif
  ...
  <script>
    ...
    Dropzone.options.uploadForm = {
      ...
      dictDefaultMessage: 'Yüklemek istediğiniz dosyayı buraya sürükleyin',
      init: function() {
