...
@section('title', $neighborhoodName.' | '.config('app.name'))
@section('header')
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Mahalle: {{ $neighborhoodName }} Mah.
                </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item">Yardım Ara</li>
                <li class="breadcrumb-item">Mahalle</li>
                <li class="breadcrumb-item active">{{$neighborhoodName}}</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
              ...
              @foreach($helps as $h)
                  ...
                  <td class="text-center">
                    @if($h->status->finisher==false)
                      ...
                      @endif
                      <a id="copy" href="{{route('yardimtalebi.copyHelpInfo',['id'=>$h->id])}}" class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="top" title="Kopyala">
