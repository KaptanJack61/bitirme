...
@section('title', $streetName.' | '.config('app.name'))
@section('header')
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Cadde & Sokak: {{ $streetName }} Mah.
                </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item">Yardım Ara</li>
                <li class="breadcrumb-item">Cadde & Sokak</li>
                <li class="breadcrumb-item active">{{$streetName}}</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
