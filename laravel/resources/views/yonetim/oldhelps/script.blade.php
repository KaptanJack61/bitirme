...
<script>
    ...
    <script type="text/javascript">
        ...
        $( document ).ready(function() {
            ...
            $('#created_date').mask('00.00.0000').focusout(function () {
                var data = $('#created_date').val();
                if(data.length != 10){
                    error('#general_alert','#created_date',true);
                }else{
                    error('#general_alert','#created_date',false);
                }
            });
            $('#updated_date').mask('00.00.0000').focusout(function () {
                var data = $('#updated_date').val();
                if(data.length != 10){
                    error('#general_alert','#updated_date',true);
                }else{
                    error('#general_alert','#updated_date',false);
                }
            });
