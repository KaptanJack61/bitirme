...
@section('title','Eski Yardım Talebi Ekle | '.config('app.name'))
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Eski ardım Talebi Ekle</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="/anasayfa">Yardım Masası</a></li>
                            <li class="breadcrumb-item">Eski Yardım Talepleri</li>
        ...
        <section class="content">
            <form role="form" id="yardimtalebi" method="post" name="yazi" action="{{ route('eskiyardimtalepleri.store') }}" enctype="multipart/form-data">
                {{ csrf_field() }}
            <div class="row">
                    ...
                    <div class="card card-warning">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="created_date" type="text" class="form-control" name="cdate"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Kapatma Tarihi</label>
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="fa fa-history"></i></span>
                                            </div>
                                            <input id="updated_date" type="text" class="form-control" name="udate"
                                                   placeholder="01.02.2020"
                                                   tabindex="0"
                                                   value="{{ old('udate') }}"
                                            >
...
@stop
@section('script')
@include('yonetim.oldhelps.script')
