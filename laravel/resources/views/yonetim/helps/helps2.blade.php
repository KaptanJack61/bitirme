            ...
            @if(Auth::guard('yonetim')->user()->admin)
                <div class="row mb-2">
                    <div class="col-sm-10">
                        <div class="row">
                            <div class="col-md-3">
                                <h1 class="m-0 text-dark">Yardımlar </h1>
                            </div>
                            <div class="col-md-2">
                                <a href="{{ route('yardimtalebi.storeIndex')  }}" class="btn btn-success" style="margin-left: -200px">
                                    <i class="fa fa-plus"></i> Yardım Talebi Ekle
                                </a>
                            </div>
                            <div class="col-md-7">

                                <form  method="post" action="{{ route('report.yardimlar') }}" style="margin-left: -200px">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-2">
                                            <select class="form-control" name="excel_help_type">
                                                <option value="0">Tüm Yardımlar</option>
                                        ...
                                        <div class="col-md-2">
                                            <select class="form-control" name="status">
                                                ...
                                                <option value="1">Açık Yardımlar</option>
                                                <option value="2">Kapalı Yardımlar</option>
                                            </select>
                                        </div>
                                        <div class="col-md-2">
...
<script type="text/javascript">
    $("#helps-table").DataTable({
        processing: true,
        serverSide: true,
        ajax : '{{ route('yapilanyardimlar.getHelps') }}',
        order: [[ 8, "desc" ]],
        columns: [
            { data: 'id', name:'id'},
            { data: 'DT_RowData.full_name', name:'person.person_slug'},
            { data: 'DT_RowData.phone', name:'person.phone'},
            { data: 'DT_RowData.help_types', name:'type.name'},
            { data: 'DT_RowData.quantity', name:'quantity'},
            {data: 'DT_RowData.neighborhoods',name: 'neighborhoods'},
            { data: 'DT_RowData.street', name:'person.street'},
