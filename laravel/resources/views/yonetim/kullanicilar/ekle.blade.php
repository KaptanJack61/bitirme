...
@section('title','Kullanıcı Ekle | '.config('app.name'))
...
@section('content')
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="/kontrolpaneli/anasayfa">Yardım Masası</a></li>
        ...
        <section class="content">
            <form role="form" id="kullanicilar" method="post" name="yazi" action="{{ route('yonetim.kullanicilar.post.ekle') }}" enctype="multipart/form-data">
                {{ csrf_field() }}
            <div class="row">
                    ...
                    <div class="card card-warning">
                        <div class="card-header text-center">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input id="thumbnail" class="form-control" type="text" name="fotograf" value="{{old('fotograf')}}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12" style="margin-top: 10px;">
                                        ...
                                        <div class="form-group">
                                            <textarea id="editor2" name="ozgecmis" style="width: 100%">
                                                {{ old('ozgecmis') }}
                                            </textarea>
                                        </div>
                                        <!-- /.card -->
                            ...
                            <div class="card-footer text-right">
                                <a href="/kontrolpaneli/kullanicilar/ekle/" id="ekle" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Ekle"><i class="fa fa-check"></i></a>
                        ...
                        <div class="card-header text-center">
                            ...
                            <div class="card-body">
                                <div class="row">
                                                ...
                                                @else
                                                    <img id="holder" width="100%" src="/img/avatar04.png" style="margin-top: -10px; margin-bottom: -10px;">
                                                @endif
                                </div>
                            </div>
                            <!-- /.card-body -->
        ...
        var iptal = {
            ...
            handleClick: function(event) {
                ...
                swal({
                    ...
                    text: "Kullanıcı ekleme ekranından ayrılacaksınız.",
                    type: 'warning',
